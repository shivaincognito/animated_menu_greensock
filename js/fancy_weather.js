...
function cloud_animation() {
  ...
  cloud_animation();
  inner_rain_animation();
  outer_rain_animation();
...
// TOMORROW
  ...
  $(".day-tomorrow").on("click", function() {
    ...
    var progress = tl_inner_rain.progress();

    if (progress == 1) {
      tl_rain_inner.pause(true);
    }
